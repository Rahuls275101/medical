  ...
  const accordionItems = [
    {
      ...
      content: "Moimply dummy text of the printing and type settingaindustry. Lorem Ipsum has been the industry's standard dummy text ever since thelong established fact thaaret"
    },
    {
      id: "collapseTwo",
    ...
    <div>
      ...
      <section className="hero-section">
        <div className="hdsd">
          ...
          <h3>Understanding biological trajectories before disease becomes obvious.</h3>
<p>Predyxiq transforms fragmented clinical observations into clear, explainable biological pathways. By connecting lifestyle signals, medical history, biomarkers, and physical measurements, it maps out organ-system trajectories that deserve clinical focus—while keeping the physician firmly at the center of every decision.</p>
...
<h3 style={{
    ...
    marginTop: "30px",
    fontSize: "20px"
  }}>Discuss a Clinical or Strategic Partnership →</h3>
            ...
            <div className="col-lg-12">
              <div className="highlight-box">
                ...
                <p className="mb-0">
                  ...
                  information every day—laboratory values, physiological measurements,
                  symptoms, medical history, imaging, and biomarkers. Yet these
                  observations are often interpreted independently, despite the fact
                  that human biology functions as an interconnected system.
                </p>
                <br />
                <p className="mb-0">
                  ...
                  variables, mapping latent physiological states, and predicting organ
                  trajectories, it delivers meaningful clinical intelligence that
                  supports faster, more confident physician decisions.
                </p>
              </div>
            </div>
          </div>
          <div className="row process text-center">
            ...
            <div className="col-lg-2 col-md-4">
              <div className="step">
                ...
                <h5>Biological<br/>Relationships</h5>
                <div className="arrow">
                  <i className="fas fa-chevron-right" />
                </div>
              </div>
            ...
            <div className="col-lg-2 col-md-4">
              <div className="step">
                ...
                <h5>Clinical<br/>Intelligence</h5>
                <div className="arrow">
                  <i className="fas fa-chevron-right" />
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="quote-box">
                ...
                <p>
                  "The value of data is not in <strong>how much we collect</strong>.
                  <br />
                  It is in <strong>how well we understand what it means.</strong>"
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="intro-text mt-4">
              Predyxiq is a clinical intelligence platform powered by
              Predyx—a deterministic, rule-based medical reasoning engine.
              It does not replace the electronic health record, nor the
              physician's diagnostic role. Instead, it introduces a highly
              structured intelligence layer between clinical data and
              clinical action.
            </p>
          </div>
          <div className="row">
      ...
      <div className="container">
        ...
        <div className="text-center mb-5">
          ...
          <p className="lead-text mt-2">
            A single laboratory value or physical measurement captures only one
            moment in time. Predyxiq identifies physiological direction by
        ...
        <div className="note-box mt-3">
          ...
          <strong> Neuro-Health</strong>,
          <strong> Longevity Markers</strong>,
          and
            ...
            <div className="container">
                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-lg-10 text-center">
                        ...
                        <p className="section-text">
                            ...
                            Predyxiq exposes the clinical rules, evidence and
                ...
                <div className="decision-card">
                    ...
                    <div className="decision-header">
                        ...
                        <span>
                            Progressive Cardiometabolic Trajectory Detected
                        </span>
                        ...
                        <div className="col-lg-5">
                            ...
                            <div className="analysis-card">
                                ...
                                <div className="analysis-block">
                                    ...
                                    <p>
                                        Multiple physiological signals are moving
                                        together, indicating coordinated progression
                                ...
                                <div className="analysis-block">
                                    ...
                                    <p>
                                        ...
                                        and schedule structured follow-up.
                                    </p>
         ...
         <section className="physician-section">
            ...
            <div className="container">
                ...
                <div className="text-center mb-5">
                    ...
                    <p className="section-text">
                        Predyxiq organizes complex clinical signals before the consultation begins,
                        highlighting meaningful physiological patterns while leaving diagnosis,
                        judgment and treatment decisions entirely to the physician.
                    </p>
...
<section className="physician-section py-5" style={{ background: "linear-gradient(135deg, #143b63, #1d5f8c)" }}>
      <div className="container">
       ...
       <div className="text-center mb-5">
                    ...
                    <h2 className="section-title" style={{color:"#fff"}}>
                      Clinical Intelligence Tailored <span style={{color:"#33dcff"}}> to Every Level of Care</span>
                    </h2>
     ...
     <section className="does-section works py-5"  style={{
...
<div className="text-center mb-5">
            ...
            <p className="section-text">
               Empowering Every Level of Healthcare
            </p>
          </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-7 mb-4 mb-lg-0 pr-4">
            ...
            <p className="sg-description">
              ...
              inputs will always generate the same transparent clinical pathway,
              giving clinicians an auditable, stable and reliable decision
              support system.
            </p>
            ...
            <div className="sg-guideline">
              ...
              <div>
                ...
                <p className="sg-description mb-0" style={{color:"#000"}}>
                  ...
                  <strong> capable of preventing disease independently</strong>.
            ...
            <div className="col-lg-6 mb-4" key={index}>
              ...
              <div className="fp-card">
                ...
                <div className="fp-content">
                  <h4 className="fp-card-title">
                    {item.title}
                  </h4>

                  <p className="fp-card-text mb-0">
                    {item.text}
                  </p>
                </div>
      ...
      <section className="funfacts" ref={ref}>
        <div className="overlay">
          <div className="container" style={{ textAlign: "center" }}>
            ...
            <p style={{
              fontSize: "16px",
              color: "#fff", marginBottom: "30px",
            }}>Discover how explainable Clinical Intelligence can strengthen preventive healthcare - from one clinical encounter to an entire population.
</p>
<a href="#" className="action-items-primary-btn1">
  Request a Demo
  <i className="fas fa-chevron-right" />
